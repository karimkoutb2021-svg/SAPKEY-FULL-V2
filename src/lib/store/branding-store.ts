...
export const DEFAULT_BRANDING: BrandingConfig = {
  ...
  footerLinks: [
    ...
    { id: '9', sectionId: 'account', label: 'الملف الشخصي', href: '/customer/profile', description: '' },
    { id: '10', sectionId: 'account', label: 'المحفظة', href: '/customer/wallet', description: '' },
    { id: '11', sectionId: 'account', label: 'طلباتي', href: '/customer/orders', description: '' },
    { id: '12', sectionId: 'account', label: 'نقاط الولاء', href: '/customer/loyalty', description: '' },
